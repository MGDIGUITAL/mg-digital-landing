                ...
                <section className="bg-background pb-2 pt-10">
                    <div className="group relative m-auto max-w-7xl px-6">
                        <div className="flex flex-col items-center md:flex-row">
                            <div className="md:max-w-44 md:border-r md:pr-6 md:border-white/20 mb-6 md:mb-0">
                                <p className="text-center md:text-end text-sm text-white/50">Powering the best teams</p>
                            </div>
